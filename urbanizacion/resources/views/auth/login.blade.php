    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h1 class="card-header">{{ __('Inicio de Sesión') }}</h1>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="col-md-6">
                                <input id="password" placeholder="Ingrese su Contraseña" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
